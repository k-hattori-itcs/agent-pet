...
public partial class App : Application
{
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        _singleInstance.Listen(() => Dispatch(ActivatePrimaryInstance));
    }
    ...
    private static void BootstrapData()
    {
        ...
        {
            AppLogger.Error("Embedded pet extraction failed.", ex);
        }
    }
    ...
    private Icon? TryLoadActivePetIcon()
    {
        ...
        {
            AppLogger.Error("Tray pet icon loading failed.", ex);
        }
