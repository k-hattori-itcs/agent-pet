...
タスクトレイから設定を開くと、`設定` を選択した位置の直上へ、そのモニターの作業領域内に収まるよう表示します。異なる拡大率のディスプレイや、左側に置いた負座標のサブディスプレイにも対応します。

キャラクターを非表示にしたまま設定を開いても、キャラクターは再表示・移動しません。キャラクターを再表示すると非表示直前の物理画面位置へ戻ります。対象モニターが外されている場合だけ、現在接続されている画面内へ補正します。
...
| キャラクター | プレビュー | 特徴 |
| --- | --- | --- |
| Koharu | <img src="docs/assets/pet-koharu.png" width="64" alt="Koharu"> | 小さな開発者コンパニオン |
| Luna | <img src="docs/assets/pet-luna.png" width="64" alt="Luna"> | 紫系パーカーのコンパニオン |
| Natsuki | <img src="docs/assets/pet-natsuki.png" width="64" alt="Natsuki"> | 金髪と日焼け肌が印象的な、活動派の夏色コンパニオン |

Natsuki は待機、左右走行、手を振る、ジャンプ、失敗、寝る、作業中、座るの全動作を備えています。
